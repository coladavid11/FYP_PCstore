...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700&family=Poppins:wght@300;400;500;700&display=swap"
    rel="stylesheet">
        ...
        <div class="col-md-11 col-lg-8">
          <div class="register-card">
            ...
            <div class="register-body">
              <?php if ($errMsg !== '') { ?>
                <div class="error-box"><i class="fa fa-triangle-exclamation"></i> <?php echo htmlentities($errMsg); ?>
                </div>
              <?php } ?>
              ...
              <form method="post" autocomplete="off">
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="phone_num" placeholder="0123456789" maxlength="15"
                        pattern="\d*" title="Please enter only digits, maximum 15 characters" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control" name="password" minlength="8" pattern="^\S{8,}$"
                        title="At least 8 characters with no spaces" required>
                    </div>
                  </div>
                ...
                <div class="text-center mt-3" style="color:#aaa;">
                  Already have an account? <a style="color:#d4af37; text-decoration:none;" href="login.php">Login
                    here</a>
                </div>
              </form>
            </div>
