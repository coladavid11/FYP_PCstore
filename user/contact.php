...
<body>
  ...
  <!-- HERO -->
  <section class="hero d-flex align-items-center text-center" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.9)),
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-7">
          <div class="dark-card p-4 p-md-5 h-100">
            ...
            <div class="d-flex justify-content-between" style="padding:14px 0;">
