...
if (isset($_POST['remove_wishlist'])) {
    ...
    $stmt = $dbh->prepare("DELETE FROM tblwishlist WHERE wishlist_id = ? AND user_id = ?");
...
<div class="container py-5">
    ...
    <?php if(count($items) == 0): ?>
        ...
        <div class="dark-card text-center py-5">
            ...
            <p class="text-secondary">Start adding your favourite products</p>

            <a href="product.php" class="btn btn-gold mt-3">
                Start Shopping
            </a>
            ...
            <?php foreach($items as $row): ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="dark-card">
                        ...
                        <img src="image/products/<?php echo $row['image']; ?>"
