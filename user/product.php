...
.filter-dropdown .dropdown-menu::-webkit-scrollbar { width: 4px; }
.filter-dropdown .dropdown-menu::-webkit-scrollbar-track { background: transparent; }
.filter-dropdown .dropdown-menu::-webkit-scrollbar-thumb { background: #444; border-radius: 2px; }
...
.filter-badge:hover { background: rgba(212,175,55,0.2); color: #d4af37; }
.filter-badge i { font-size: 0.65rem; }
...
<div class="container pb-5">
    ...
    <div class="filter-bar">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <div class="dropdown filter-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><hr class="dropdown-divider" style="border-color:#2a2a2a; margin:4px 0;"></li>
        ...
        <div class="active-filters">
            ...
            <?php endif; ?>
            <a href="product.php" class="filter-badge" style="border-color:#555; color:#888; background:transparent;">
            ...
            <a href="product_details.php?id=<?php echo $p['product_id']; ?>" class="product-card h-100">
                ...
                <div class="product-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between product-footer">
                        ...
                        <?php else: ?>
                            <span class="badge" style="background:rgba(40,167,69,0.15); color:#28a745; font-size:0.7rem; border:1px solid rgba(40,167,69,0.25);">
                                In Stock
                            </span>
                        <?php endif; ?>
                    </div>
