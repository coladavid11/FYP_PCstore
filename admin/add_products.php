...
.topbar h1 { font-size:1.5rem; color:#111; font-weight:600; }
.btn-back {
    display:inline-flex; align-items:center; gap:6px;
    padding:9px 18px; border-radius:4px; font-size:0.85rem;
    font-weight:500; background:#f5f5f5; color:#555;
    text-decoration:none; border:1px solid #e0e0e0; transition:0.2s;
}
.btn-back:hover { background:#e0e0e0; color:#222; }
.btn-save {
    display:inline-flex; align-items:center; gap:6px;
    padding:9px 22px; border-radius:4px; font-size:0.85rem;
    font-weight:600; background:#d4af37; color:#000;
    border:none; cursor:pointer; transition:0.2s; font-family:'Poppins',sans-serif;
}
.btn-save:hover { background:#000; color:#d4af37; }

/* ── ALERT ── */
.alert {
    display:flex; align-items:flex-start; gap:10px;
    padding:14px 18px; border-radius:4px;
    margin-bottom:20px; font-size:0.88rem; font-weight:500; line-height:1.5;
}
...
/* ── CARD ── */
.card { background:#fff; border-radius:6px; box-shadow:0 2px 8px rgba(0,0,0,0.06); overflow:hidden; margin-bottom:20px; }
.card-header {
...
.card-header h3 { font-size:0.95rem; font-weight:600; color:#111; margin:0; }
...
label span.req { color:#dc3545; margin-left:2px; }
...
select {
    ...
    color:#333; background:#fafafa; transition:border-color 0.2s;
}
input:focus, textarea:focus, select:focus {
    outline:none; border-color:#d4af37;
    background:#fff; box-shadow:0 0 0 3px rgba(212,175,55,0.08);
}
textarea { resize:vertical; min-height:100px; }

/* border highlight for invalid fields */
input.field-error, select.field-error { border-color:#dc3545 !important; background:#fff8f8; }

.input-prefix {
    display:flex; align-items:center;
    border:1px solid #e0e0e0; border-radius:4px; overflow:hidden; background:#fafafa;
}
.input-prefix span {
    padding:10px 12px; background:#f5f5f5; color:#888;
    font-size:0.88rem; border-right:1px solid #e0e0e0; white-space:nowrap;
}
.input-prefix input { border:none; border-radius:0; flex:1; background:transparent; }
.input-prefix input:focus { box-shadow:none; }
.input-prefix:focus-within { border-color:#d4af37; box-shadow:0 0 0 3px rgba(212,175,55,0.08); }

.form-row { display:grid; grid-template-columns:1fr 1fr; gap:14px; }

/* ── SPEC TABS ── */
.spec-tabs { display:flex; flex-wrap:wrap; gap:6px; margin-bottom:16px; }
.spec-tab {
    padding:5px 12px; border-radius:20px; font-size:0.75rem;
    font-weight:500; cursor:pointer; transition:all 0.2s;
    border:1px solid #e0e0e0; background:#fff; color:#888;
}
.spec-tab:hover { border-color:#d4af37; color:#d4af37; }
.spec-tab.active { background:#d4af37; border-color:#d4af37; color:#000; font-weight:600; }

.spec-section { display:none; }
.spec-section.active { display:block; }
.spec-hint { font-size:0.72rem; color:#bbb; margin-top:4px; }
...
.img-drop-zone i { font-size:2rem; color:#ccc; display:block; margin-bottom:8px; }
.img-drop-zone p { font-size:0.82rem; color:#aaa; margin:0; }
.img-drop-zone .drop-sub { font-size:0.72rem; color:#ccc; margin-top:4px; }

/* Preview appears here after file select */
.img-preview-wrap {
    display:none; border:2px dashed #d4af37;
    border-radius:8px; overflow:hidden; background:#fafafa;
    text-align:center; margin-bottom:14px; position:relative;
}
.img-preview-wrap img { max-width:100%; max-height:220px; object-fit:contain; display:block; margin:0 auto; }
.img-preview-name {
    padding:8px 12px; background:#fffdf5;
    font-size:0.72rem; color:#888; border-top:1px solid #f0f0f0;
    display:flex; align-items:center; gap:6px;
}
.img-preview-name i { color:#d4af37; }
.btn-remove-img {
...
.upload-note {
    background:#fffbeb; border:1px solid rgba(212,175,55,0.3);
    border-radius:4px; padding:10px 12px; font-size:0.75rem; color:#8a6900;
    display:flex; gap:8px; align-items:flex-start;
}
.upload-note i { color:#d4af37; margin-top:1px; flex-shrink:0; }

/* ── PROGRESS INDICATOR ── */
.form-steps {
    display:flex; align-items:center; gap:0; margin-bottom:24px;
    background:#fff; border-radius:6px; padding:16px 20px;
    box-shadow:0 2px 8px rgba(0,0,0,0.05); flex-wrap:wrap; gap:8px;
}
.step-item {
    display:flex; align-items:center; gap:8px; font-size:0.78rem; color:#bbb;
}
.step-item.done   { color:#28a745; }
.step-item.active { color:#d4af37; font-weight:600; }
.step-num {
    width:24px; height:24px; border-radius:50%;
    display:flex; align-items:center; justify-content:center;
    font-size:0.7rem; font-weight:700; border:2px solid #e0e0e0; color:#bbb; background:#fff;
}
.step-item.done   .step-num { background:#28a745; border-color:#28a745; color:#fff; }
.step-item.active .step-num { background:#d4af37; border-color:#d4af37; color:#000; }
.step-sep { width:30px; height:2px; background:#e0e0e0; flex-shrink:0; }
.step-sep.done { background:#28a745; }
</style>
</head>
<body>
...
<div class="main">
    ...
    <div class="topbar">
        <div>
            ...
            <div style="font-size:0.75rem;color:#aaa;margin-top:2px;">Fill in all required fields and upload a product image.</div>
        </div>
    ...
    <div class="alert alert-success">
        ...
        <div><?php echo $msg; ?> &nbsp;<a href="products.php" style="color:#155724;font-weight:600;">View all products →</a></div>
    </div>
    <?php endif; ?>
    ...
    <div class="form-layout">
        ...
        <div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name"
                               ...
                               placeholder="e.g. MSI Cyborg 15 Gaming Laptop"
                               required>
                    </div>
            ...
            <!-- 2. TECHNICAL SPECS (TABBED) -->
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-microchip"></i>
                    <h3>Technical Specifications <span style="color:#bbb;font-weight:400;font-size:0.8rem;">(Optional)</span></h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="spec-tabs">
                        ...
                        <div class="spec-tab <?php echo $first ? 'active' : ''; ?>"
                            ...
                            <i class="fa <?php echo $tab['icon']; ?>" style="margin-right:4px;font-size:0.7rem;"></i>
                            <?php echo $tab['label']; ?>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="upload-note">
                        ...
                        <div>
                            ...
                            and saved to
                            <code style="background:#fff3cd;padding:1px 4px;border-radius:2px;">../image/products/</code>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid #f5f5f5;"
                        ...
                        <div style="width:20px;height:20px;border-radius:50%;border:2px solid <?php echo $done ? '#28a745' : '#e0e0e0'; ?>;
