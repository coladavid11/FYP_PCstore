...
if (isset($_POST['update_product'])) {
    ...
    if (!empty($_FILES['image']['name']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!$deleteImage && !empty($product->image)) {
            ...
            if (file_exists($oldPathFull)) unlink($oldPathFull);
        }
...
/* ── IMAGE SECTION ── */
.img-preview-wrap {
    position:relative; border:2px dashed #e0e0e0;
...
.img-placeholder i { font-size:2.5rem; margin-bottom:8px; display:block; }
.img-placeholder p { font-size:0.78rem; }

.delete-img-wrap {
    display:flex; align-items:center; gap:8px;
    padding:10px 12px; background:#fff5f5;
    border:1px solid rgba(220,53,69,0.2); border-radius:4px;
    margin-bottom:12px;
}
.delete-img-wrap label {
    color:#dc3545; font-size:0.78rem; text-transform:none;
    letter-spacing:0; margin:0; cursor:pointer; display:flex;
    align-items:center; gap:6px; font-weight:500;
}
.delete-img-wrap input[type="checkbox"] {
    width:16px; height:16px; cursor:pointer; accent-color:#dc3545;
}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label>
                                ...
                                if ($s <= 0)   echo '<span class="stock-indicator stock-out">Out of Stock</span>';
                                elseif ($s < 5) echo '<span class="stock-indicator stock-low">Low Stock</span>';
                                else           echo '<span class="stock-indicator stock-ok">In Stock</span>';
                                ?>
                            </label>
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($product->image)): ?>
                    <!-- CURRENT IMAGE PATH -->
                    <div style="font-size:0.72rem;color:#aaa;margin-bottom:12px;word-break:break-all;padding:6px 10px;background:#fafafa;border-radius:4px;border:1px solid #f0f0f0;">
                    ...
                    <div class="upload-note">
                        ...
                        <div>
                            ...
                            File saved to <code style="background:#fff3cd;padding:1px 4px;border-radius:2px;">../image/products/</code>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <div style="display:flex;justify-content:space-between;align-items:center;padding:9px 0;border-bottom:1px solid #f5f5f5;">
                        <span style="font-size:0.78rem;color:#aaa;display:flex;align-items:center;gap:7px;">
                            <i class="fa <?php echo $icon; ?>" style="color:#d4af37;width:14px;text-align:center;"></i>
                            <?php echo $lbl; ?>
                        </span>
            ...
            <div class="card">
                <div class="card-body">
                    <button type="submit" name="update_product" class="btn-save" style="width:100%;justify-content:center;padding:13px;">
                        <i class="fa fa-floppy-disk"></i> Save Changes
                    </button>
                    <a href="products.php" class="btn-back" style="width:100%;justify-content:center;margin-top:10px;display:flex;">
