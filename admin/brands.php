        ...
        <form method="GET" action="brands.php" id="filterForm">
            <div class="filter-bar">
                <div class="search-wrap">
                    ...
                    <input type="text" name="search" class="search-input" placeholder="Search brand name…"
                    ...
                    <?php if (!empty($brands)): ?>
                        <?php foreach ($brands as $brand): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($brand->product_count > 0): ?>
                                        <span class="count-badge count-active">
                                            ...
                                            product<?php echo $brand->product_count != 1 ? 's' : ''; ?>
                                        </span>
                                    <?php else: ?>
                                ...
                                <td><span class="date-text"><?php echo date('d M Y', strtotime($brand->created_at)); ?></span>
                                </td>
