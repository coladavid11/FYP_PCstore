                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-16" aria-controls="submenu-5"><i
                                        class="fa fa-address-card"></i>Super Admin</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-11" aria-controls="submenu-5"><i
                                        class="fa fa-fw fa-user-circle"></i></i>User</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-13" aria-controls="submenu-5"><i
                                        class="fa fa-server"></i>Categories</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-14" aria-controls="submenu-5"><i
                                        class="fa fa-desktop"></i>Products</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-12" aria-controls="submenu-5"><i
                                        class="fa fa-truck"></i>Order</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-15" aria-controls="submenu-5"><i
                                        class="fas fa-fw fa-table"></i>Report</a>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Guardian Gaming Admin
                                                Dashboard</li>
                                        </ol>
                                    </nav>
                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td colspan="6" style="text-align: center;">There is no
                                                                record(s) in this table</td>
                                                        </tr>
                                                        <?php
                                                    }
