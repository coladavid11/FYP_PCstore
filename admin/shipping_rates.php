...
$sql = "SELECT rate_id, state_id, fee FROM tbl_shipping_rate ORDER BY rate_id ASC";
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .card { background: #fff; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 24px; }
        table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        th { background: #fafafa; color: #d4af37; font-weight: 600; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 0.5px; padding: 14px; text-align: left; border-bottom: 2px solid #f0f0f0; }
        td { padding: 14px; border-bottom: 1px solid #f0f0f0; color: #333; font-size: 0.88rem; }
        .btn-edit { color: #d4af37; text-decoration: none; font-weight: 500; }
...
<body>
    ...
    <tr>
        ...
        <td><strong>Region / Zone <?php echo htmlspecialchars($rate->state_id); ?></strong></td>
    ...
    <?php endforeach; else: ?>
    <tr>
        <td colspan="4" style="text-align:center; color:#999;">No shipping configurations initialized in the system database.</td>
    </tr>
    <?php endif; ?>
</tbody>
            </table>
