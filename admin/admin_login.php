...
body {
    ...
    background-color: #ffffff; /* Deep black background */
    height: 100vh;
    display: flex;
    align-items: center;
...
.login-card {
    background-color: #ffffff; /* Dark grey card */
    width: 100%;
    max-width: 400px;
    padding: 50px 40px;
    border-radius: 4px;
...
.form-label {
    display: none; /* Hidden to match the placeholder-only style in your image */
}

.form-control {
    width: 100%;
    background-color: #ffffff; /* Slightly darker than the card */
...
.form-control:focus {
    border-color: #ccac3d; /* Gold border on click */
}
...
.show-password-wrapper label {
    color: #ffffff; /* FIX: Changed from black to white for visibility */
    font-size: 0.85rem;
    cursor: pointer;
}
...
.show-password-wrapper input[type="checkbox"] {
    cursor: pointer;
    accent-color: #ccac3d; /* Golden checkbox color */
}

/* 6. Login Button */
.btn-login {
    width: 100%;
    background-color: #ccac3d; /* Specific gold from image_009a1d.png */
    color: #000;
    padding: 15px;
    border: none;
    border-radius: 4px;
