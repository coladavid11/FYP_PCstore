...
<body>
    ...
    <div class="main">
        ...
        <?php if ($success): ?>
            <div class="alert-success"><i class="fa-solid fa-circle-check"></i> Shipping baseline matrix configuration
            ...
            <form method="POST">
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-label">Destination Territory / State</label>
                        <input type="text" class="form-control" disabled
                            value="<?php echo htmlspecialchars($rate->state_name); ?>">
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input type="number" step="0.01" min="0" name="fee" class="form-control"
                            value="<?php echo htmlspecialchars($rate->fee); ?>" required>
                    </div>
                </div>
